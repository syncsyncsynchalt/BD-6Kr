...
【ステップ6】出撃準備とマップ選択
  出撃準備を開始中...
  戦略画面（母港）に遷移中...
MonoBehaviour Mock constructor called for StrategyTopTaskManager
  マップ選択画面に遷移中...
  出撃可能なマップを確認中...
...
=== 戦闘結果 ===
  勝利判定: S / MVP: 大井(1)(mstId:24)[23/25 => 23/25(25/25)]番艦
  敵艦:
    1. 軽巡ホ級: 53 → 0 [撃沈]
    2. 駆逐イ級後期型: 35 → 0 [撃沈]
    3. 駆逐イ級: 20 → 0 [撃沈]
...
=== 出撃艦隊の状態 ===
  艦隊規模: 6隻
  1. 吹雪 (Lv.3) HP:4/15 [中破]
  2. 大井 (Lv.3) HP:23/25 [小破]
  3. Z3 (Lv.2) HP:1/18 [大破]
  4. 瑞鳳改 (Lv.2) HP:45/45 [良好]
  5. 飛鷹 (Lv.2) HP:40/40 [良好]
...
=== 戦闘結果 ===
  勝利判定: C / MVP: 飛鷹(4)(mstId:75)[30/40 => 30/40(40/40)]番艦
  敵艦:
    1. 軽巡ヘ級: 57 → 50 [無傷]
    2. 駆逐イ級後期型: 35 → 24 [小破]
    3. 駆逐イ級: 20 → 0 [撃沈]
