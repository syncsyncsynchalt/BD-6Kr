...
namespace UnityEngine.Rendering
{
	public struct SphericalHarmonicsL2
	{
		...
		private static void INTERNAL_CALL_ClearInternal(ref SphericalHarmonicsL2 sh) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_AddAmbientLightInternal(ref Color color, ref SphericalHarmonicsL2 sh) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_AddDirectionalLightInternal(ref Vector3 direction, ref Color color, ref SphericalHarmonicsL2 sh) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
