...
namespace UnityEngine
{
	public struct Quaternion
	{
		...
		private static Quaternion INTERNAL_CALL_AngleAxis(float angle, ref Vector3 axis) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Quaternion INTERNAL_CALL_FromToRotation(ref Vector3 fromDirection, ref Vector3 toDirection) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Quaternion INTERNAL_CALL_LookRotation(ref Vector3 forward, ref Vector3 upwards) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Quaternion INTERNAL_CALL_Slerp(ref Quaternion a, ref Quaternion b, float t) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Quaternion INTERNAL_CALL_SlerpUnclamped(ref Quaternion a, ref Quaternion b, float t) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Quaternion INTERNAL_CALL_Lerp(ref Quaternion a, ref Quaternion b, float t) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Quaternion INTERNAL_CALL_LerpUnclamped(ref Quaternion a, ref Quaternion b, float t) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Quaternion INTERNAL_CALL_Inverse(ref Quaternion rotation) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Vector3 INTERNAL_CALL_Internal_ToEulerRad(ref Quaternion rotation) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Quaternion INTERNAL_CALL_Internal_FromEulerRad(ref Vector3 euler) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_Internal_ToAxisAngleRad(ref Quaternion q, out Vector3 axis, out float angle) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Quaternion INTERNAL_CALL_AxisAngle(ref Vector3 axis, float angle) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
