...
namespace UnityEngine
{
	public class GUILayoutUtility
	{
		...
		private static Rect Internal_GetWindowRect(int windowID) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_Internal_MoveWindow(int windowID, ref Rect r) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		internal static Rect GetWindowsBounds() { throw new NotImplementedException("‚È‚É‚±‚ê"); }
	}
}
