	...
	public class GUI
	{
		...
		private static int DoButtonGrid(Rect position, int selected, GUIContent[] contents, int xCount, GUIStyle style, GUIStyle firstStyle, GUIStyle midStyle, GUIStyle lastStyle)
		{
			...
			case EventType.Repaint:
			{
				...
				for (int i = 0; i < num; i++)
				{
					GUIStyle gUIStyle2 = (i == 0) ? firstStyle : midStyle;
					if (i == num - 1)
					{
						gUIStyle2 = lastStyle;
					}
		...
		private static void INTERNAL_get_color(out Color value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void INTERNAL_set_color(ref Color value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void INTERNAL_get_backgroundColor(out Color value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void INTERNAL_set_backgroundColor(ref Color value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void INTERNAL_get_contentColor(out Color value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void INTERNAL_set_contentColor(ref Color value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static string Internal_GetTooltip() { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void Internal_SetTooltip(string value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static string Internal_GetMouseTooltip() { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_DoLabel(ref Rect position, GUIContent content, IntPtr style) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void InitializeGUIClipTexture() { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static bool INTERNAL_CALL_DoButton(ref Rect position, GUIContent content, IntPtr style) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static void SetNextControlName(string name) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static string GetNameOfFocusedControl() { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static void FocusControl(string name) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static bool INTERNAL_CALL_DoToggle(ref Rect position, int id, bool value, GUIContent content, IntPtr style) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		internal static void InternalRepaintEditorWindow() { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Rect INTERNAL_CALL_DoModalWindow(int id, ref Rect clientRect, WindowFunction func, GUIContent content, GUIStyle style, GUISkin skin) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Rect INTERNAL_CALL_DoWindow(int id, ref Rect clientRect, WindowFunction func, GUIContent title, GUIStyle style, GUISkin skin, bool forceRectOnLayout) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_DragWindow(ref Rect position) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static void BringWindowToFront(int windowID) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static void BringWindowToBack(int windowID) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static void FocusWindow(int windowID) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static void UnfocusWindow() { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void Internal_BeginWindows() { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void Internal_EndWindows() { throw new NotImplementedException("‚È‚É‚±‚ê"); }
	}
}
