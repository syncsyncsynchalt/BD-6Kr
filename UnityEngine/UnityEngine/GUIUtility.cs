...
namespace UnityEngine
{
	public class GUIUtility
	{
		...
		private static float Internal_GetPixelsPerPoint() { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static int GetControlID(int hint, FocusType focus) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static int INTERNAL_CALL_Internal_GetNextControlID2(int hint, FocusType focusType, ref Rect rect) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		internal static int GetPermanentControlID() { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static int Internal_GetHotControl() { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void Internal_SetHotControl(int value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		internal static void UpdateUndoName() { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		internal static void SetDidGUIWindowsEatLastEvent(bool value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static GUISkin Internal_GetDefaultSkin(int skinMode) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static Object Internal_GetBuiltinSkin(int skin) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void Internal_ExitGUI() { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		internal static int Internal_GetGUIDepth() { throw new NotImplementedException("‚È‚É‚±‚ê"); }
	}
}
