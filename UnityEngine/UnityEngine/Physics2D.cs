...
namespace UnityEngine
{
	public class Physics2D
	{
		...
		private static void INTERNAL_get_gravity(out Vector2 value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void INTERNAL_set_gravity(ref Vector2 value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static void IgnoreCollision(Collider2D collider1, Collider2D collider2, [DefaultValue("true")] bool ignore) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		public static bool GetIgnoreCollision(Collider2D collider1, Collider2D collider2) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		public static bool IsTouching(Collider2D collider1, Collider2D collider2) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static bool IsTouchingLayers(Collider2D collider, [DefaultValue("AllLayers")] int layerMask) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_Internal_Linecast(ref Vector2 start, ref Vector2 end, int layerMask, float minDepth, float maxDepth, out RaycastHit2D raycastHit) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static RaycastHit2D[] INTERNAL_CALL_LinecastAll(ref Vector2 start, ref Vector2 end, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static int INTERNAL_CALL_LinecastNonAlloc(ref Vector2 start, ref Vector2 end, RaycastHit2D[] results, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_Internal_Raycast(ref Vector2 origin, ref Vector2 direction, float distance, int layerMask, float minDepth, float maxDepth, out RaycastHit2D raycastHit) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static RaycastHit2D[] INTERNAL_CALL_RaycastAll(ref Vector2 origin, ref Vector2 direction, float distance, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static int INTERNAL_CALL_RaycastNonAlloc(ref Vector2 origin, ref Vector2 direction, RaycastHit2D[] results, float distance, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_Internal_CircleCast(ref Vector2 origin, float radius, ref Vector2 direction, float distance, int layerMask, float minDepth, float maxDepth, out RaycastHit2D raycastHit) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static RaycastHit2D[] INTERNAL_CALL_CircleCastAll(ref Vector2 origin, float radius, ref Vector2 direction, float distance, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static int INTERNAL_CALL_CircleCastNonAlloc(ref Vector2 origin, float radius, ref Vector2 direction, RaycastHit2D[] results, float distance, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_Internal_BoxCast(ref Vector2 origin, ref Vector2 size, float angle, ref Vector2 direction, float distance, int layerMask, float minDepth, float maxDepth, out RaycastHit2D raycastHit) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static RaycastHit2D[] INTERNAL_CALL_BoxCastAll(ref Vector2 origin, ref Vector2 size, float angle, ref Vector2 direction, float distance, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static int INTERNAL_CALL_BoxCastNonAlloc(ref Vector2 origin, ref Vector2 size, float angle, ref Vector2 direction, RaycastHit2D[] results, float distance, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_Internal_GetRayIntersection(ref Ray ray, float distance, int layerMask, out RaycastHit2D raycastHit) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static RaycastHit2D[] INTERNAL_CALL_GetRayIntersectionAll(ref Ray ray, float distance, int layerMask) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static int INTERNAL_CALL_GetRayIntersectionNonAlloc(ref Ray ray, RaycastHit2D[] results, float distance, int layerMask) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Collider2D INTERNAL_CALL_OverlapPoint(ref Vector2 point, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Collider2D[] INTERNAL_CALL_OverlapPointAll(ref Vector2 point, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static int INTERNAL_CALL_OverlapPointNonAlloc(ref Vector2 point, Collider2D[] results, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Collider2D INTERNAL_CALL_OverlapCircle(ref Vector2 point, float radius, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Collider2D[] INTERNAL_CALL_OverlapCircleAll(ref Vector2 point, float radius, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static int INTERNAL_CALL_OverlapCircleNonAlloc(ref Vector2 point, float radius, Collider2D[] results, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Collider2D INTERNAL_CALL_OverlapArea(ref Vector2 pointA, ref Vector2 pointB, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static Collider2D[] INTERNAL_CALL_OverlapAreaAll(ref Vector2 pointA, ref Vector2 pointB, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static int INTERNAL_CALL_OverlapAreaNonAlloc(ref Vector2 pointA, ref Vector2 pointB, Collider2D[] results, int layerMask, float minDepth, float maxDepth) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
	}
}
