...
namespace UnityEngine
{
	public sealed class RectTransformUtility
	{
		...
		private static bool INTERNAL_CALL_RectangleContainsScreenPoint(RectTransform rect, ref Vector2 screenPoint, Camera cam) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static Vector2 PixelAdjustPoint(Vector2 point, Transform elementTransform, Canvas canvas)
		{
			PixelAdjustPoint(point, elementTransform, canvas, out Vector2 output);
			return output;
		}
		...
		private static void INTERNAL_CALL_PixelAdjustPoint(ref Vector2 point, Transform elementTransform, Canvas canvas, out Vector2 output) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static Rect PixelAdjustRect(RectTransform rectTransform, Canvas canvas) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
