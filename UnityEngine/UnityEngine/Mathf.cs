...
namespace UnityEngine
{
	public struct Mathf
	{
		...
		public static int ClosestPowerOfTwo(int value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static float GammaToLinearSpace(float value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static float LinearToGammaSpace(float value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static bool IsPowerOfTwo(int value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static int NextPowerOfTwo(int value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		public static float PerlinNoise(float x, float y) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		public static ushort FloatToHalf(float val) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		public static float HalfToFloat(ushort val) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
