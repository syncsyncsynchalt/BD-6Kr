...
namespace UnityEngine
{
	public struct RaycastHit
	{
		...
		public Vector2 textureCoord
		{
			get
			{
				CalculateRaycastTexCoord(out Vector2 output, collider, m_UV, m_Point, m_FaceID, 0);
				return output;
			}
		}
		...
		public Vector2 textureCoord2
		{
			get
			{
				CalculateRaycastTexCoord(out Vector2 output, collider, m_UV, m_Point, m_FaceID, 1);
				return output;
			}
		}
		...
		private static void INTERNAL_CALL_CalculateRaycastTexCoord(out Vector2 output, Collider col, ref Vector2 uv, ref Vector3 point, int face, int index) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
	}
}
