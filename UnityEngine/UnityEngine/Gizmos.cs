...
namespace UnityEngine
{
	public sealed class Gizmos
	{
		...
		public static Matrix4x4 matrix
		{
			get
			{
				INTERNAL_get_matrix(out Matrix4x4 value);
				return value;
			}
			set
			{
		...
		private static void INTERNAL_CALL_DrawLine(ref Vector3 from, ref Vector3 to) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_DrawWireSphere(ref Vector3 center, float radius) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_DrawSphere(ref Vector3 center, float radius) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_DrawWireCube(ref Vector3 center, ref Vector3 size) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_DrawCube(ref Vector3 center, ref Vector3 size) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_DrawMesh(Mesh mesh, int submeshIndex, ref Vector3 position, ref Quaternion rotation, ref Vector3 scale) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_DrawWireMesh(Mesh mesh, int submeshIndex, ref Vector3 position, ref Quaternion rotation, ref Vector3 scale) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_DrawIcon(ref Vector3 center, string name, bool allowScaling) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_DrawGUITexture(ref Rect screenRect, Texture texture, int leftBorder, int rightBorder, int topBorder, int bottomBorder, Material mat) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_get_matrix(out Matrix4x4 value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }

		private static void INTERNAL_set_matrix(ref Matrix4x4 value) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
		...
		private static void INTERNAL_CALL_DrawFrustum(ref Vector3 center, float fov, float maxRange, float minRange, float aspect) { throw new NotImplementedException("‚È‚É‚±‚ê"); }
	}
}
