...
public abstract class UIRect : MonoBehaviour
{
	...
	public class AnchorPoint
	{
		...
		public Vector3[] GetSides(Transform relativeTo)
		{
			if (target != null)
			{
				...
				if (((Component)target).GetComponent<Camera>() != null)
				{
	...
	{
		mAnchorsCached = true;
		leftAnchor.rect = ((!leftAnchor.target) ? null : ((Component)leftAnchor.target).GetComponent<UIRect>());
		bottomAnchor.rect = ((!bottomAnchor.target) ? null : ((Component)bottomAnchor.target).GetComponent<UIRect>());
		rightAnchor.rect = ((!rightAnchor.target) ? null : ((Component)rightAnchor.target).GetComponent<UIRect>());
		topAnchor.rect = ((!topAnchor.target) ? null : ((Component)topAnchor.target).GetComponent<UIRect>());
