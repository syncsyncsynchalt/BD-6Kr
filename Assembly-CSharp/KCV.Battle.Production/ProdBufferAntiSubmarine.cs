...
namespace KCV.Battle.Production
{
	public class ProdBufferAntiSubmarine : BaseProdBuffer
	{
        ...
        {
            base.animation.Play(AnimationList.ProdBufferAntiSubmarine.ToString());
			SoundUtils.PlaySE(SEFIleInfos.SE_926a);

            throw new NotImplementedException("‚È‚É‚±‚ê");
            // yield return new WaitForSeconds(base.animation.get_Item(AnimationList.ProdBufferAntiSubmarine.ToString()).length);
