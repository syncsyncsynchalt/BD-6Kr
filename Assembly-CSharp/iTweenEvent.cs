...
public class iTweenEvent : MonoBehaviour
{
	...
	private IEnumerator StartEvent()
	{
		...
		internalName = $"{internalName}-{Guid.NewGuid().ToString()}";
	...
	private void init()
	{
		if (myPosition == new Vector3(0f, 0f, 0f))
		{
			...
			myPosition = new Vector3(x, y, localPosition3.z);
		}
		base.gameObject.transform.localPosition = new Vector3(myPosition.x, myPosition.y, myPosition.z);
	}
}
