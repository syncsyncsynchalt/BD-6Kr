...
public class UIButton : UIButtonColor
{
	...
	public CallBackSetState callBack;
	...
	protected override void OnEnable()
	{
		if (isEnabled)
		{
			if (mInitDone)
			{
				...
				else if (!OnEnableAndOnDisableChangeState)
				{
	...
	public override void SetState(State state, bool immediate)
	{
		...
		if (callBack != null && (state == State.Hover || state == State.Pressed))
		{
			callBack(this);
		}
	}

	public void SetStateNonCallBack(State state)
	{
		base.SetState(state, instant: true);
		if (mSprite != null)
		{
			switch (state)
			{
