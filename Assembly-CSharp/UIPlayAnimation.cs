...
public class UIPlayAnimation : MonoBehaviour
{
	...
	{
		mStarted = true;
		if ((Object)target == null && (Object)animator == null)
		{
		...
		if ((Object)target != null && ((Behaviour)target).enabled)
		{
	...
	{
		if (!(Object)target && !(Object)animator)
		{
			return;
		}
		if (onlyIfDifferent)
		...
		ActiveAnimation activeAnimation = (!(Object)target) ? ActiveAnimation.Play(animator, clipName, direction, ifDisabledOnPlay, disableWhenFinished) : ActiveAnimation.Play(target, clipName, direction, ifDisabledOnPlay, disableWhenFinished);
