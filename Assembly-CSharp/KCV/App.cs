...
namespace KCV
{
	public static class App
	{
		...
		public static readonly System.Random rand = new System.Random((int)DateTime.Now.Ticks & 0xFFFF);

		public static readonly string[] SYATEI_TEXT = new string[5]
		{
			"無",
			"短",
			"中",
		...
		public static DateTime SystemDateTime
		{
			get
			{
				...
				return DateTime.Now.AddHours(9.0);
			}
		}

		public static DayOfWeek DayOfWeek => SystemDateTime.DayOfWeek;

		public static TitleManager GetTitleManager()
		{
			return _clsTitleManager;
		}
		...
		public static bool Initialize()
		{
			...
			_clsTitleManager.CreateSaveData(DEBUG_ADMIRAL_NAME, DEBUG_DEFAULT_FLAGSHIP_ID, DEBUG_DIFFICULT);
		...
		public static void InitLoadMasterDataManager()
		{
			...
			{
				_isAtKeastOneMstLoadThread = true;
