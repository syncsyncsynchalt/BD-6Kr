...
namespace KCV
{
	...
	{
		public static AnimationCurve TweenEaseOutBack = new AnimationCurve(new Keyframe[11]
		{
		...
		public static AnimationCurve TweenEaseInOutQuad = new AnimationCurve(new Keyframe[11]
		{
		...
		public static AnimationCurve TweenEaseOutExpo = new AnimationCurve(new Keyframe[11]
		{
			...
			new Keyframe(0.4f, 0.9375f, 15f / 32f, 15f / 32f),
			new Keyframe(0.5f, 31f / 32f, 15f / 64f, 15f / 64f),
			new Keyframe(0.6f, 63f / 64f, 0.11719f, 0.11719f),
