...
namespace UnityEngine.Networking
{
	...
	public class NetworkBehaviour : MonoBehaviour
	{
		...
		protected class Invoker
		{
			...
			{
				return invokeType + ":" + invokeClass + ":" + invokeFunction.Method.Name;
			}
		}
		...
		internal static void DumpInvokers()
		{
			...
			{
				Debug.Log("  Invoker:" + s_CmdHandlerDelegate.Value.invokeClass + ":" + s_CmdHandlerDelegate.Value.invokeFunction.Method.Name + " " + s_CmdHandlerDelegate.Value.invokeType + " " + s_CmdHandlerDelegate.Key);
			}
		}
