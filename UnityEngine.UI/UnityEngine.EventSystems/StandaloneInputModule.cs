...
namespace UnityEngine.EventSystems
{
	...
	public class StandaloneInputModule : PointerInputModule
	{
		...
		public override bool ShouldActivateModule()
		{
			...
			forceModuleActive |= Input.GetButtonDown(m_CancelButton);
			forceModuleActive |= !Mathf.Approximately(Input.GetAxisRaw(m_HorizontalAxis), 0f);
			forceModuleActive |= !Mathf.Approximately(Input.GetAxisRaw(m_VerticalAxis), 0f);
